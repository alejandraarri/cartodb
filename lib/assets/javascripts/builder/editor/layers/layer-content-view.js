...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    var context = this._stateDefinitionModel.getContext();
    this.model.set('context', context || CONTEXTS.map);
  ...
  _onTogglerChanged: function () {
    ...
    this._updateContextState(context);
  ...
  _updateContextState: function (context) {
    var json = _.clone(this._stateDefinitionModel.get('json'));
    json.context = context;
    this._stateDefinitionModel.updateState(json);
  },
