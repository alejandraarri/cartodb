...
describe('stack-layout/view', function () {
  ...
  describe('onChangePosition', function () {
    ...
    it('should retrieve context when there is a position change', function () {
      spyOn(this.view, '_getContext').and.callThrough();
      this.viewModel.nextStep();
      expect(this.view._getContext).toHaveBeenCalled();
      this.view._getContext.and.returnValue(undefined);
      this.viewModel.prevStep();
      this.view._getContext.and.returnValue('map');
    });
